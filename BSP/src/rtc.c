...
//  
//  RTC_Date.RTC_Year = TPB21.R_Buffer[22]*10+TPB21.R_Buffer[24];
//  RTC_Date.RTC_Month = TPB21.R_Buffer[26]*10+TPB21.R_Buffer[28];
//  RTC_Date.RTC_Date = TPB21.R_Buffer[30]*10+TPB21.R_Buffer[32];
//  RTC_Date.RTC_WeekDay = RTC_Weekday_Monday;
//  
//  RTC_Time.RTC_Hours   = TPB21.R_Buffer[34]*10+TPB21.R_Buffer[36];
//  RTC_Time.RTC_Minutes = TPB21.R_Buffer[38]*10+TPB21.R_Buffer[40];
//  RTC_Time.RTC_Seconds = TPB21.R_Buffer[42]*10+TPB21.R_Buffer[44];
//  
